    ...
    return (
      <div className=" h-80 mt-9 ">
        <div className=" grid grid-cols-3 container gap-6">
          <div className="p-5">
            <h1 className="text-large  font-sans">i am web developer</h1>
            <Image
              src={Line}
              alt="line image"
              srcSet=""
            ...
            <div className="flex">
              <div>
                <span className="text-large">6</span>
                <h3>
                  YEARS OF <br />
                  EXPERIENCE
                </h3>
              ...
              <div className="pl-20">
                <span className="text-large">34</span>
                <h3>
                  PROJECT <br />
                  DONE
                </h3>
          ...
          <div className="">
            ...
            <h3 className="  text-large">
              ...
              image based on the imported file.
            </h3>
